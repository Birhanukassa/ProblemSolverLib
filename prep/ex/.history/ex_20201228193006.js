...
///////////////////////////////////////////
//Excute Program
// Write a function at(arr, i) that returns the element 
//at index i. It should return null if given an index not in the array.
//function at(arr, i) { 
...
/* Write a function that puts a 0 in element 1 of an array. 
Make sure that the function returns null. 
Returning null makes it clear that the function modifies 
the array.*/
...
console.log(f(array3));
console.log(f(array4));
console.log(f(array5));
console.log(f(array6));
