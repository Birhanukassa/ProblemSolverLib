...
// bigger ones “bubble” to the top. This algorithm requires quadratic time and constant space.
...
// Insertion Sort
// Like bubble sort, every item is compared with every other item. Instead of swapping, 
// it “splices” in the correct order. In effect, it maintains the original order of repeated items. 
...
// Selection Sort
// As the loop iterates through a collection, this algorithm finds and “selects” the index 
// with the lowest value and swaps it with the beginning index wherever appropriate. 
...
// Quick Sort
// This algorithm recursively selects an element as the pivot and iteratively pushes all the 
// smaller elements to the left and all the larger elements to the right until all is sorted. 
// This algorithm requires quadratic time and logarithmic space such that in practice is 
// often the fastest. As such, most programming languages natively implement 
