...
6 kyu
Mexican Wave
83323093% of 3,3657,912 of 27,118adrian.eyre
JavaScript
...
function wave(str) {
  ...
  for (let char = 0; char < str.length; char++) {
    if (str[char] !== ' ') {
      let capital = str[char].toUpperCase();
      let first = str.substring(0, char);
      let last = str.substring(char + 1);
      result.push(first + capital + last);
    }
  }
  return result;
}
...
//Should return: ' Gap , gAp , gaP ' - Expected: [' Gap ', ' gAp ', ' gaP ']
// instead got: [' gap ', ' Gap ', ' gAp ', ' gaP ', ' gap ']

// Should return: Hello,hEllo,heLlo,helLo,hellO'
// - Expected: ['Hello', 'hEllo', 'heLlo', 'helLo', 'hellO'],
// instead got:['Hello', 'hEllo', 'heLlo', 'heLlo', 'hellO']
